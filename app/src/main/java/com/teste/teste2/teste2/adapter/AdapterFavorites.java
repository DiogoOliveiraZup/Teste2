...
public class AdapterFavorites extends BaseAdapter {
    ...
    public AdapterFavorites(Context context, List<MovieSearchInfomations.SearchEntity> movieItem) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final View rowView = inflater.inflate(R.layout.favorites, parent, false);
